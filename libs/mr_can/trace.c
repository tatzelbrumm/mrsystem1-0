...
*
* Kurzbeschreibung: trace functionality for CAN UDP frames
*
\**********************************************************************/
...
*
* Kurzbeschreibung: this function decodes a cs2/ms2 CAN message and
*                   prints all parameters
*
* Parameter:
* CanMsg : CAN message after call of MrCs2Decode or MrEthCs2Decode
*
\**********************************************************************/
         ...
         case MR_MS2_CMD_CFGDAT_STREAM:
            switch (MrCs2GetNumParamBytes(CanMsg))
            {
               case 6:
                  ...
                  break;
               case 7:
                  MrCs2DecCfgdatStream7(CanMsg, &Length, &p1, &(Buf[0]));
                  printf("Config Data Stream (Length = %ld, Crc = %d, Byte6 = 0x%x)\n",
                         Length, p1, Buf[0]);
                  break;
               case 8:
