...
*
* Kurzbeschreibung: test if encode and decode produce same result
*
\**********************************************************************/
...
/**********************************************************************\
* Funktionsname: InitVars
*
* Kurzbeschreibung: this function initializes the variables for test
*
* Parameter:
* s*: pointer to source variables, will be initialized to random value
* e*: pointer to result variables, will be initialized to s*
*
\**********************************************************************/
...
/**********************************************************************\
* Funktionsname: TestVars
*
* Kurzbeschreibung: this function checks, if source is equal result
*
* Parameter:
* s*: source variables
* e*: result variables
...
* Funktionsname: main
*
* Kurzbeschreibung: calls encoder and decoder and checks result
*
* Parameter:
*
\**********************************************************************/
...
{  MrMs2CanDataType CanMsg;
   ...
   InitVars(&sUid, &sSid, &s1, &s2, &s3, &s4, &s5, &eUid, &eSid, &e1, &e2, &e3, &e4, &e5);
   MrCs2EncReadConfig7(&CanMsg, sUid, s1, s2);
   eUid = 0;
   e1 = 0;
   e2 = 0;
   MrCs2DecReadConfig7(&CanMsg, &eUid, &e1, &e2);
