/**********************************************************************\
* Dateiname: m_cs2ms2.h
* Autor    : Michael Bernstein
* Projekt  :
*
* Copyright (C) Daniel Prein, Gerhard Bertelsmann, Michael Bernstein
*
* Kurzbeschreibung: definitions for of ms1/ms2 can messages
*
\**********************************************************************/
...
#define MrMs2CalcHash(CanMsg,Uid) MrCs2CalcHash(CanMsg,Uid)
